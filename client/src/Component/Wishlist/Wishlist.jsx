    ...
    return (
            ...
            <Component container>
                <LeftComponent item lg={9} md={9} sm={12} xs={12}>
                    <Header>
                        <Typography style={{fontWeight: 600, fontSize: 18}}>My WishList({cartItems?.length})</Typography>
                    </Header>
                        {   cartItems.map((item,idx) => (
                                <WishlistIteam  item={item} key={idx} removeItemFromCart={removeItemFromCart}/>
                            ))
                        }
                    <BottomWrapper>
